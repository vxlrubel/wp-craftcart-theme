...
class CC_Nav_Walker extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = null ) {
      ...
      echo $depth;
		...
		$output .= '<ul class="category-sub-menu bg-1 TabletopSubMenu"><div class="row g-4">';
	}
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
      ...
      if( $depth == 0 ){
         if( $menu_item->megamenu == true ){
            ...
            $item_output .= '<div>';
            $item_output .= '<a href="#" class="nav-link">';
            $item_output .= $title;
            $item_output .= '</a>';
            $item_output .= '</div>';
            ...
            $item_output .= '<div class="d-flex"><a class="nav-link" aria-current="page" href="#">';
            $item_output .= $title;
            $item_output .= '</a></div>';
         }
      }else{
